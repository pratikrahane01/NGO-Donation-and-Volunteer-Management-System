                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <button data-ajax-modal="true" data-url="ngo_volunteers.php?modal=approval_form&id=<?php echo $reg['id'] ?? ''; ?>" class="action-btn" style="width: 32px; height: 32px;" title="Update Approval Status">
                                                <i class="fas fa-check-circle"></i>
                                            </button>
                                            <button data-ajax-modal="true" data-url="ngo_volunteers.php?modal=attendance_form&id=<?php echo $reg['id'] ?? ''; ?>" class="action-btn" style="width: 32px; height: 32px; color: var(--primary);" title="Update Attendance & Hours">
