                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <button data-ajax-modal="true" data-url="admin_donations.php?modal=view_details&id=<?php echo $don['id'] ?? ''; ?>" class="action-btn" style="width: 32px; height: 32px;" title="View Details">
