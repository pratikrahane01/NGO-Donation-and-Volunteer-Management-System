...
if (isset($_GET['modal'])) {
    if ($_GET['modal'] === 'campaign_form') {
        ...
        <div class="modal">
            ...
            <form method="POST" action="ngo_campaigns.php" class="ajax-form">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                ...
                <div class="header-actions">
                    <button data-ajax-modal="true" data-url="ngo_campaigns.php?modal=campaign_form" class="btn-primary"><i class="fas fa-plus"></i> New Campaign</button>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px; justify-content: flex-end;">
                                            ...
                                            <button class="action-btn" data-ajax-modal="true" data-url="ngo_campaigns.php?modal=campaign_form&id=<?php echo $camp['id'] ?? ''; ?>" title="Edit">
