                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <button data-ajax-modal="true" data-url="coordinator_events.php?modal=edit_event&id=<?php echo $evt['id'] ?? ''; ?>" class="action-btn" style="width: 32px; height: 32px;" title="Edit Event">
